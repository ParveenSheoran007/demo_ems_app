...
class EditManageSalaryRatesScreen extends StatefulWidget {
  ...
  EditManageSalaryRatesScreen({
    ...
    String initialratesPattern,
  });

  final void Function(String) onSave;

  @override
  _EditManageSalaryRatesScreenState createState() => _EditManageSalaryRatesScreenState();
}

class _EditManageSalaryRatesScreenState extends State<EditManageSalaryRatesScreen> {
